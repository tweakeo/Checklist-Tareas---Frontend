...
- **Leer tareas de HOY**: query a la fuente de la biblioteca filtrando `ES HOY = "true"` y `Hecha hoy = "false"` (filtros de tipo string sobre fórmula). Agrupar por `RESPONSABLE` y/o `TURNO`.
...
- ✅ Vista "HOY — Por persona" (y/o "Por turno") con tarjetas grandes + botón Check.
